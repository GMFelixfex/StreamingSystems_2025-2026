...
// In-memory implementation of the IQuery interface, maintaining the current state of vehicles based on applied events.
public class InMemoryReadModel implements IQuery {
    ...
    // Helper method to remove a vehicle's name from the position index when it moves or is removed.
