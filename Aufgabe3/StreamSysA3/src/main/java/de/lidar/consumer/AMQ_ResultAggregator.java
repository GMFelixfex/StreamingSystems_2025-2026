...
public class AMQ_ResultAggregator implements MessageListener {
    ...
    public void start() throws Exception {
        ...
        System.out.println("Aggregator aktiv. Ergebnisse werden in resultsMQ.txt geschrieben... Drücken Sie Enter zum Beenden.");
        System.in.read();
    ...
    public void onMessage(Message m) {
        try {
            ...
            UtilFunctions.writeResults(totals, "resultsMQ.txt");
