...
public class UtilFunctions {
    ...
    public synchronized static void writeResults(TreeMap<Integer, Double> totals, String filename) throws IOException {
        try (PrintWriter pw = new PrintWriter(new FileWriter("data\\" + filename))) {
